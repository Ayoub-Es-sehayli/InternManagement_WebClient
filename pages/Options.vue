<template>
    <section class="form">
       <b-field label="Nombre de Stagiaires par unité">
           <b-numberinput v-model="configurationModel.internsNumber" 
                          placeholder="1" 
                          :min="1"
                          :editable="false"
                          expanded
       ...
       <b-field label="Jours d'absence par semaine">
           <b-numberinput v-model="configurationModel.daysAbsence" 
                          placeholder="1" 
                          :min="1"
                          :max="5"
                          :editable="false"
       ...
       <b-field>
          <nuxt-link  to="/UpdatePassword" ><b-button expanded class="changerMotdePasse">Changer le mot de passe</b-button></nuxt-link>
       </b-field>
       <b-field>
           <b-button expanded class="sauvegarder" size="is-medium" @click="SaveConfiguration()">Sauvegarder</b-button>
       </b-field>
    </section>
</template>
